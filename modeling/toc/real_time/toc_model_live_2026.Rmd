...
sensor_data <- load_sensor_data()%>% 
  filter(DT_round >= ymd("2023-08-01") & DT_round <= ymd("2025-12-31"))%>%
...
Looking at the plots, we can see that the tuned hyperparameter model has only marginally improved our results. It appears that fold 2 has the worst performance which is likely due to the distribution of the validation set being the widest and contains the sites (JOEI: lowest TOC, PENN: high TOC, low turb). We will save this model and we still see similar performance to previous model versions
